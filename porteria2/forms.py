...
class  FormIngreso(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        hoy = date.today()
        self.fields['conductor'].queryset = Conductor.objects.filter(is_deleted = False,vencimiento_carnet__gte = hoy)
        self.fields['conductor'].empty_label='Seleccione un conductor'
        self.fields['patente_chasis'].queryset = Camion.objects.filter(is_deleted = False, vencimiento_seguro__gte = hoy )
        self.fields['patente_chasis'].empty_label = 'Seleccione un camión'
        self.fields['patente_semi'].queryset = Semi.objects.filter(is_deleted = False, vencimiento_seguro__gte = hoy)
